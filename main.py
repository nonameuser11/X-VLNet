...
def _run_on_single_gpu(model, batch_list_t, batch_list_v, batch_sequence_output_list,batch_seq_features_list, batch_visual_output_list):
    ...
    for idx1, b1 in enumerate(batch_list_t):
        ...
        for idx2, b2 in enumerate(batch_list_v):
            ...
            # a = input(f"b1b2_logits type : {type(b1b2_logits)} _ type :{type(_)}")
            # b1b2_logits += _s
...
def eval_epoch(args, model, test_dataloader, device, n_gpu):
    ...
    with torch.no_grad():
        ...
        #     batch_list_t_splits = [] #batch_list_t
        #     batch_list_v_splits = [] #batch_list_v
        #     batch_t_output_splits = [] #batch_sequence_output_list
        #     batch_sf_output_splits = [] #batch_seq_features_list
        #     batch_v_output_splits = [] #batch_visual_output_list
        ...
        #                               batch_t_output_splits[dev_id],batch_sf_output_splits[dev_id], batch_v_output_splits[dev_id]) for dev_id in device_ids]
        #     model, batch_list_t, batch_list_v, batch_sequence_output_list,batch_seq_features_list, batch_visual_output_list
