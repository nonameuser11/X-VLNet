...
class CLIP4Clip(CLIP4ClipPreTrainedModel):
    ...
    def _loose_similarity(self, sequence_output,seq_features, visual_output, attention_mask, video_mask, sim_header="meanP"):
        ...
        #Higher threshold means elevate the degree of false negative throunghly 
        #video_threshold = self.score_threshold+0.2 # 이렇게 했더니 24.7이 나옴..
        #sentence_threshold = self.score_threshold-0.2
        ...
        frame_word_logits = logit_scale * self._SUMA(word_features,frame_features)
    ...
    def _SUMA(self, word_features, frame_features):
